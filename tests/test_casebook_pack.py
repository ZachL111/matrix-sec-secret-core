"""Regression checks for the matrix-sec-secret-core casebook."""
...
from casebook.harness import assert_expected, matrix_sec_secret_core_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(matrix_sec_secret_core_summary(), assert_expected())
